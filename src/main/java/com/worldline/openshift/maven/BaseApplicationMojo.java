...
public abstract class BaseApplicationMojo extends BaseOpenshift {
	...
	protected abstract void doExecute(IOpenShiftConnection connection, IApplication application)
	...
	protected void dumpApplication(final String prefix, final IApplication application,
			final List<IEmbeddedCartridge> embeddedCartridgesByApp) {
