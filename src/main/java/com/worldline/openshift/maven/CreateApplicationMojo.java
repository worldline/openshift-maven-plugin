...
public class CreateApplicationMojo extends BaseApplicationMojo {
	...
	protected void doExecute(final IOpenShiftConnection connection) {
		...
		final IApplication app = userDomain.createApplication(application, new StandaloneCartridge(cartridge),
				ApplicationScale.valueOf(scale.toUpperCase()), new GearProfile(gearProfile));
